...
var playGymVideoButton = document.querySelector('.gym__play-button');
var gymVideoCover = document.querySelector('.gym__video-cover');
var gymVideoFrame = document.querySelector('.gym__video-player iframe');
var registrationForm = document.querySelector('.registration__form');
var formSubmit = document.querySelector('.registration__form').querySelector('button');
var formInput = document.querySelector('.registration__form').querySelector('input');
if (window.matchMedia('(max-width: 767px)').matches && infoList !== null) {
  var rows = Math.ceil((infoList.children.length + 1) / 2);
  infoList.setAttribute('style', "grid-template-rows: repeat(".concat(rows, ", 1fr);"));
}
if (playGymVideoButton !== null && gymVideoCover !== null && gymVideoFrame !== null) {
  playGymVideoButton.addEventListener('click', function () {
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/tabs/init-tabs":11,"./utils/ios-vh-fix":14}],2:[function(require,module,exports){
"use strict";
